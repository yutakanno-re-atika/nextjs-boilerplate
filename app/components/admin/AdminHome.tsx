                      ...
                      <table className="w-full text-left">
                          ...
                          <tbody className="divide-y divide-gray-50 text-sm">
                              ...
                              {data?.castings?.slice(0, 3).map((c: any) => {
                                  ...
                                  return (
                                      <tr key={c.id} className="hover:bg-gray-50 transition cursor-pointer" onClick={() => onNavigate('DATABASE')}>
                      ...
                      {activeReservations.length === 0 ? (
                          ...
                          <ul className="divide-y divide-gray-100">
                              {activeReservations.map((res: any) => {
                                  ...
                                  return (
                                      <li key={res.id} className="p-4 hover:bg-gray-50 transition cursor-pointer" onClick={() => onNavigate('OPERATIONS')}>
