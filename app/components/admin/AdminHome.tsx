    ...
    <div className="flex flex-col animate-in fade-in duration-500 max-w-[1400px] mx-auto w-full space-y-6 pb-12 font-sans text-gray-800">
      ...
      <header className="flex items-center justify-between border-b border-gray-200 pb-4">
        <div>
          ...
          <p className="text-xs font-mono text-gray-500 mt-1 uppercase tracking-widest">Tomakomai Plant Dashboard</p>
        </div>
        <div className="text-right">
             <div className="text-xs text-gray-400 font-bold mb-1">CURRENT COPPER</div>
             <div className="text-2xl font-black text-[#D32F2F] tracking-tighter">¥{currentCopperPrice.toLocaleString()}</div>
        </div>
      </header>

      {/* 🔴 Quick Status Bar (New Design) */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-sm overflow-hidden">
          <div className="bg-white p-4 hover:bg-gray-50 cursor-pointer transition group" onClick={() => onNavigate('OPERATIONS')}>
              <div className="flex justify-between items-center mb-2">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Today's Entry</span>
          ...
          <div className="bg-white p-4 hover:bg-gray-50 cursor-pointer transition group" onClick={() => onNavigate('PRODUCTION')}>
              <div className="flex justify-between items-center mb-2">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Yard Stock</span>
              ...
              <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded ml-2">UNPROCESSED</span>
              </div>
          </div>
          ...
          <div className="bg-white p-4 hover:bg-gray-50 cursor-pointer transition group" onClick={() => onNavigate('SALES')}>
              <div className="flex justify-between items-center mb-2">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Targets</span>
              ...
              <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-xs font-bold text-gray-400">社</span>
                  <span className="text-[10px] text-[#D32F2F] font-bold ml-2">ACTIVE</span>
              </div>
          </div>
      </div>

      {/* 🔴 Main Metrics (Black & White Theme) */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          
          {/* Asset Card */}
          <div className="bg-[#111] text-white p-6 rounded-sm shadow-lg flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="mt-8">
                  ...
                  <div className="text-xs text-gray-500 mt-1 font-mono">Stock: {totalProducedCopper.toLocaleString()} kg</div>
              </div>
          ...
          <div className="lg:col-span-3 bg-white border border-gray-200 p-6 rounded-sm shadow-sm flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1 w-full border-r border-gray-100 pr-4">
                  <div className="flex justify-between items-start mb-2">
                      <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Monthly Purchase (Weight)</h4>
                  ...
                  <div className={`text-xs font-bold mt-2 flex items-center ${currentMonthStats.diffWeight >= 0 ? 'text-gray-900' : 'text-[#D32F2F]'}`}>
                       {currentMonthStats.diffWeight >= 0 ? '+' : ''}{currentMonthStats.diffWeight.toLocaleString()} kg <span className="text-gray-400 font-normal ml-1">vs last month</span>
                  </div>
              </div>

              <div className="flex-1 w-full">
                  <div className="flex justify-between items-start mb-2">
                      <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Monthly Purchase (Amount)</h4>
                  ...
                  <div className={`text-xs font-bold mt-2 flex items-center ${currentMonthStats.diffAmount >= 0 ? 'text-gray-900' : 'text-[#D32F2F]'}`}>
                       {currentMonthStats.diffAmount >= 0 ? '+' : ''}{currentMonthStats.diffAmount.toLocaleString()} JPY <span className="text-gray-400 font-normal ml-1">vs last month</span>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white border border-gray-200 p-6 rounded-sm shadow-sm">
              <div className="flex justify-between items-center mb-8">
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Annual Trend</h3>
                      ...
                      return (
                          <div key={data.month} className="flex-1 flex flex-col justify-end items-center h-full group relative">
                             {/* Tooltip */}
                              ...
                              ></div>
                              <span className={`text-[9px] font-mono mt-2 ${isCurrent ? 'text-[#D32F2F] font-bold' : 'text-gray-400'}`}>{data.month}</span>
                          </div>
                      );
                  })}
              </div>
          ...
          <div className="bg-white border border-gray-200 p-6 rounded-sm shadow-sm flex flex-col">
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-6">Yield Performance Top 5</h3>
              <div className="flex-1 space-y-2">
                  {clientYieldRanking.length === 0 ? (
                      <div className="h-full flex items-center justify-center text-gray-300 text-xs">No Data</div>
                  ) : (
                          ...
                          <div key={idx} onClick={() => onNavigate('CLIENT_DETAIL', client.name)} className="flex items-center justify-between p-3 border border-gray-100 hover:border-gray-300 hover:bg-gray-50 transition cursor-pointer rounded-sm group">
                              <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                      ...
                                      <p className="text-[9px] text-gray-400 mt-0.5">Total: {client.totalInput.toLocaleString()}kg</p>
                                  </div>
                              </div>
                              <div className="text-right">
      ...
      <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          <div className="flex border-b border-gray-200 bg-gray-50">
              <button onClick={() => setBottomTab('PRICING')} className={`px-6 py-3 text-xs font-bold tracking-widest uppercase transition-colors ${bottomTab === 'PRICING' ? 'bg-white border-t-2 border-t-[#D32F2F] text-gray-900' : 'text-gray-400 hover:text-gray-600'}`}>Pricing Calc</button>
              <button onClick={() => setBottomTab('ROI')} className={`px-6 py-3 text-xs font-bold tracking-widest uppercase transition-colors ${bottomTab === 'ROI' ? 'bg-white border-t-2 border-t-[#D32F2F] text-gray-900' : 'text-gray-400 hover:text-gray-600'}`}>Processing ROI</button>
          </div>
              ...
              {bottomTab === 'PRICING' && (
                  <div className="animate-in fade-in duration-300">
                      <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                           <span className="text-xs font-bold text-gray-500">Margin Setting</span>
                           <div className="flex items-center gap-3">
                      ...
                      <div className="max-h-[400px] overflow-auto">
                          <table className="w-full text-left border-collapse">
                              <thead className="bg-gray-50 sticky top-0 z-10 border-b border-gray-200">
                                  <tr>
                                      <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Product</th>
                                      <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-center">Cu Ratio</th>
                                      <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Value</th>
                                      <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Buy Price</th>
                                      <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Profit</th>
                                  </tr>
                              </thead>
              ...
              {bottomTab === 'ROI' && (
                  <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in duration-300">
                      <div className="space-y-4">
                          <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 block">Target Wire</label>
                          ...
                          <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 block">Weight (kg)</label>
                              <input type="number" className="w-full p-2 bg-gray-50 border border-gray-200 rounded-sm text-xs font-bold outline-none focus:border-gray-400" value={roiWeight} onChange={e => setRoiWeight(Number(e.target.value))} />
                          </div>
                          <div className="grid grid-cols-2 gap-4">
                              <div>
                                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 block">Hours</label>
                                  <input type="number" step="0.5" className="w-full p-2 bg-gray-50 border border-gray-200 rounded-sm text-xs font-bold outline-none focus:border-gray-400" value={roiHours} onChange={e => setRoiHours(Number(e.target.value))} />
                              </div>
                              <div>
                                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 block">Hourly Wage</label>
                                  <input type="number" className="w-full p-2 bg-gray-50 border border-gray-200 rounded-sm text-xs font-bold outline-none focus:border-gray-400" value={roiWage} onChange={e => setRoiWage(Number(e.target.value))} />
                              </div>
                          </div>
                      </div>
                      ...
                      <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="border border-gray-200 p-5 rounded-sm flex flex-col justify-between">
                              <div>
                                  <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Sell as Scrap</h4>
                                  <p className="text-[10px] text-gray-400">Unit: ¥{wholesalePricePerKg} / kg</p>
                              </div>
                          ...
                          <div className={`p-5 rounded-sm flex flex-col justify-between border ${isProcessingBetter ? 'bg-[#111] text-white border-black' : 'bg-gray-50 border-gray-200'}`}>
                              <div>
                                  <h4 className={`text-xs font-bold uppercase tracking-widest mb-1 ${isProcessingBetter ? 'text-gray-400' : 'text-gray-500'}`}>Process & Sell</h4>
                                  <p className={`text-[10px] ${isProcessingBetter ? 'text-gray-500' : 'text-gray-400'}`}>Cu: {theoreticalCopperWeight.toFixed(1)}kg / Cost: -¥{processingCost.toLocaleString()}</p>
                              </div>
                          ...
                          <div className="sm:col-span-2 mt-2 flex justify-between items-center p-4 bg-gray-50 border border-gray-200 rounded-sm">
                              <span className="text-xs font-bold text-gray-600 uppercase tracking-widest">AI Recommendation</span>
                              <div className="text-right">
                                  ...
                                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{isProcessingBetter ? 'PROCESS' : 'SELL NOW'}</p>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      {/* 🔴 Analytics (Log & Inventory) */}
      <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          <div className="flex border-b border-gray-200 bg-gray-50">
              <button onClick={() => setAnalyticsTab('LOG')} className={`px-6 py-3 text-xs font-bold tracking-widest uppercase transition-colors ${analyticsTab === 'LOG' ? 'bg-white border-t-2 border-t-[#D32F2F] text-gray-900' : 'text-gray-400 hover:text-gray-600'}`}>Recent Logs</button>
              <button onClick={() => setAnalyticsTab('INVENTORY')} className={`px-6 py-3 text-xs font-bold tracking-widest uppercase transition-colors ${analyticsTab === 'INVENTORY' ? 'bg-white border-t-2 border-t-[#D32F2F] text-gray-900' : 'text-gray-400 hover:text-gray-600'}`}>Unprocessed Stock</button>
          </div>
             ...
             {analyticsTab === 'LOG' && (
                  <table className="w-full text-left border-collapse">
                      <thead className="bg-white sticky top-0 z-10 border-b border-gray-200">
                          <tr>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Date / Client</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Material</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">In</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Out</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Yield</th>
                          </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100">
                  ...
                  <table className="w-full text-left border-collapse">
                      <thead className="bg-white sticky top-0 z-10 border-b border-gray-200">
                          <tr>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Date / Client</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">Product</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-center">Exp. Yield</th>
                              <th className="py-3 px-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-right">Stock</th>
                          </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100">
                          {lotInventory.length === 0 ? (<tr><td colSpan={4} className="py-8 text-center text-xs text-gray-400 font-medium">No Data</td></tr>) : lotInventory.map((lot: any, idx: number) => (
                              <tr key={idx} className="hover:bg-gray-50 transition">
                                  <td className="py-2 px-6">
