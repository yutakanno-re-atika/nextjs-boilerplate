...
export const AdminDashboard = ({ data, setView, onLogout }: { data: any; setView: any; onLogout?: any }) => {
  const [adminTab, setAdminTab] = useState<'HOME' | 'OPERATIONS' | 'POS' | 'PRODUCTION' | 'COMPETITOR'>('HOME');
  ...
  const handleNavigate = (tab: 'HOME' | 'OPERATIONS' | 'POS' | 'PRODUCTION' | 'COMPETITOR', resId?: string) => {
