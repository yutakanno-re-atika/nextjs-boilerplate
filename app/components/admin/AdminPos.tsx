          ...
          <div className="bg-white border border-gray-200 shadow-sm flex flex-col flex-1 rounded-sm overflow-hidden mb-4">
              ...
              <div className="p-3 md:p-5 flex-1 overflow-y-auto bg-white relative">
                          ...
                          <div key={idx} className={`flex flex-col md:flex-row gap-3 md:gap-2 md:items-center p-3 md:p-2 rounded-sm border transition-colors relative ${item.isNewFlag ? 'bg-orange-50 border-orange-200' : 'bg-gray-50 border-gray-200 hover:border-gray-300'}`}>
                              ...
                              <div className="flex gap-2 items-center w-full md:w-auto">
                                  <div className="flex-1 md:w-40 relative">
                                      <span className="md:hidden absolute -top-2 left-2 bg-gray-50 px-1 text-[10px] font-bold text-gray-400 flex items-center gap-1 z-10">重量</span>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 mt-6">
                      <button onClick={addItem} className="flex-1 py-4 border-2 border-dashed border-gray-300 rounded-sm text-gray-500 font-bold hover:border-gray-500 hover:text-gray-700 hover:bg-gray-100 transition flex items-center justify-center gap-2 text-sm bg-gray-50 shadow-sm">
                          <Icons.Plus /> 品目を手動で追加
                      </button>
