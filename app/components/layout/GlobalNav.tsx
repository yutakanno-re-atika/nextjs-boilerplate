...
export default function WireMasterCloud() {
  ...
  // トップページ (LP)
  return (
    // 修正: pt-20 を削除 (ヒーロー画像を最上部に配置するため)
    <div className="min-h-screen bg-white text-[#111] font-sans">
        ...
        <>
            ...
            <section className="relative min-h-[700px] flex items-center bg-black text-white overflow-hidden py-20 lg:py-0">
                ...
                <div className="max-w-[1400px] mx-auto px-6 w-full relative z-20">
                    {/* PCレイアウト調整: mt-20を追加してヘッダーとの重なりを回避 */}
                    <div className="grid lg:grid-cols-12 gap-12 items-center pt-20">
                        {/* LEFT COLUMN: COPY */}
      ...
      {/* SUB PAGES - LP内で表示する場合 (例: モーダルやアンカーリンク遷移後) */}
      {/* ※ view切り替えロジック上、FLOW/MEMBERSHIPもLPと同じdiv内にレンダリングされますが、
         レイアウト崩れを防ぐため、ここでは別枠として扱いません。
         もし別ページ風に見せたい場合は、上部の if (view === '...') でリターンさせてください。
      */}
      {view === 'FLOW' && (
        <div className="pt-20">
           <FlowGuide />
